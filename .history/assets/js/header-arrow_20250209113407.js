...
document.addEventListener("DOMContentLoaded", function () {
    const navbarItems = document.querySelectorAll(".navbar__items li");
    ...
    if (navbarItems.length > 0) {
        ...
        if (lastLink && !lastLink.querySelector(".down-arrow")) {
            lastLink.insertAdjacentHTML(
                "beforeend",
                `<svg class="down-arrow" fill="#fff" width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
