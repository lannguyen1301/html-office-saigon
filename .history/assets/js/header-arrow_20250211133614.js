...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const svgIcons = {
        facebook: `<svg width="20" height="20" viewBox="0 0 24 24"><path d="M12 2L1 12h3v8h7v-5h2v5h7v-8h3L12 2z"/></svg>`,
        youtube: `<svg width="20" height="20" viewBox="0 0 24 24"><path d="M12 2L1 12h3v8h7v-5h2v5h7v-8h3L12 2z"/></svg>`,
        twitter: `<svg width="20" height="20" viewBox="0 0 24 24"><path d="M12 2L1 12h3v8h7v-5h2v5h7v-8h3L12 2z"/></svg>`,
