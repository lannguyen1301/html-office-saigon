function slide(link) {
    var down = function (callback, time) {
        ...
        up = function (callback, time) {
            ...
            var paddingTop = parseInt(
                window.getComputedStyle(subMenu).paddingTop
            );
            var paddingBottom = parseInt(
...
var accordion = (function () {
    var menu = document.querySelectorAll(".frequently_navbar__list");
                ...
                if (e.target.classList.contains(activeClass)) {
                    ...
                    if (arr.length > 0) {
                        slide(arr[i - 1]).up(function () {
                            ...
                            console.log(
                                "slide up of accordion " + i + " is done"
                            );
                        }, timer);
                    }
                    ...
                    slide(e.target).down(function () {
                        ...
                        console.log(
                            "slide down of accordion " + i + " is done"
                        );
                    }, timer);
                }
            }
