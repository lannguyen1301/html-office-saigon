...
// // Breadcrumb arrow
// document.querySelectorAll(".navbar__items:not(:last-child) a").forEach((a) => {
//     a.insertAdjacentHTML(
//         "beforeend",
//         `<svg class="down-arrow" fill="#fff" width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M11.178 19.569a.998.998 0 0 0 1.644 0l9-13A.999.999 0 0 0 21 5H3a1.002 1.002 0 0 0-.822 1.569l9 13z"/></svg>`
//     );
...
//         // Tìm thẻ <a> bên trong nó
//         const lastLink = lastItem.querySelector("a");

//         // Chỉ thêm icon nếu có thẻ <a> và chưa có SVG (tránh trùng lặp)
//         if (lastLink && !lastLink.querySelector(".breadcrumb-arrow")) {
//             lastLink.insertAdjacentHTML(
//                 "beforeend",
//                 `<svg class="breadcrumb-arrow" extends ParentClass {super() } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            if (item !== lastItem) {
                ...
                if (link && !link.querySelector(".breadcrumb-arrow")) {
                    link.insertAdjacentHTML(
                        "beforeend",
                        `<svg class="breadcrumb-arrow" width="12px" fill="var(--font-color)" width="12px" height="12px" 
