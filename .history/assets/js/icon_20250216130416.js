...
// home bar
// home
document.querySelectorAll(".navbar__mobile-item:first-child a").forEach((a) => {
    a.insertAdjacentHTML(
        "beforeend",
        `<svg class="icon__bar-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M0 96C0 78.3 14.3 64 32 64l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 128C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 288c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32L32 448c-17.7 0-32-14.3-32-32s14.3-32 32-32l384 0c17.7 0 32 14.3 32 32z"/></svg>`
    );
});
...
document.addEventListener("DOMContentLoaded", function () {
    console.log("JavaScript đã được tải thành công!"); // Kiểm tra mã có chạy không

    // Mảng chứa các SVG tương ứng với từng ID
    const svgIcons = {
        building: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M48 0C21.5 0 0 21.5 0 48L0 464c0 26.5 21.5 48 48 48l96 0 0-80c0-26.5 21.5-48 48-48s48 21.5 48 48l0 80 96 0c26.5 0 48-21.5 48-48l0-416c0-26.5-21.5-48-48-48L48 0z"/></svg>`,
        location_1: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M192 0C86 0 0 86 0 192c0 110 192 320 192 320s192-210 192-320C384 86 298 0 192 0zM192 272c-44 0-80-36-80-80s36-80 80-80 80 36 80 80-36 80-80 80z"/></svg>`,
        // location_2: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M192 0C86 0 0 86 0 192c0 110 192 320 192 320s192-210 192-320C384 86 298 0 192 0zM192 272c-44 0-80-36-80-80s36-80 80-80 80 36 80 80-36 80-80 80z"/></svg>`,
        rental: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M0 80C0 53.5 21.5 32 48 32l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48L0 80zM64 96l0 64 64 0 0-64L64 96zM0 336c0-26.5 21.5-48 48-48l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48l0-96zm64 16l0 64 64 0 0-64-64 0zM304 32l96 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48l-96 0c-26.5 0-48-21.5-48-48l0-96c0-26.5 21.5-48 48-48zm80 64l-64 0 0 64 64 0 0-64zM256 304c0-8.8 7.2-16 16-16l64 0c8.8 0 16 7.2 16 16s7.2 16 16 16l32 0c8.8 0 16-7.2 16-16s7.2-16 16-16s16 7.2 16 16l0 96c0 8.8-7.2 16-16 16l-64 0c-8.8 0-16-7.2-16-16s-7.2-16-16-16s-16 7.2-16 16l0 64c0 8.8-7.2 16-16 16l-32 0c-8.8 0-16-7.2-16-16l0-160zM368 480a16 16 0 1 1 0-32 16 16 0 1 1 0 32zm64 0a16 16 0 1 1 0-32 16 16 0 1 1 0 32z"/></svg>`,
        tel: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M511 383c0-14-2-28-6-41-3-10-15-15-24-12l-110 36c-10 3-16 13-14 23 1 6 2 12 4 18 2 5 0 10-4 14-31 31-79 31-110 0L70 317c-31-31-31-79 0-110 4-4 9-6 14-4 6 2 12 3 18 4 10 2 20-4 23-14l36-110c3-9-2-21-12-24-13-4-27-6-41-6-71 0-128 57-128 128 0 212 172 384 384 384 71 0 128-57 128-128z"/></svg>`,
        hotline: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M16 64C16 28.7 44.7 0 80 0L304 0c35.3 0 64 28.7 64 64l0 384c0 35.3-28.7 64-64 64L80 512c-35.3 0-64-28.7-64-64L16 64z"/></svg>`,
        website: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M352 256c0 22.2-1.2 43.6-3.3 64h-185.3c-2.2-20.4-3.3-41.8-3.3-64s1.2-43.6 3.3-64h185.3c2.2 20.4 3.3 41.8 3.3 64z"/></svg>`,
        email: `<svg class="icon__company-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M48 64c-26.5 0-48 21.5-48 48 0 15.1 7.1 29.3 19.2 38.4l217.6 163.2c11.4 8.5 27 8.5 38.4 0l217.6-163.2c12.1-9.1 19.2-23.3 19.2-38.4 0-26.5-21.5-48-48-48H48z"/></svg>`,
    };

    // Lặp qua tất cả các ID có trong danh sách
    Object.keys(svgIcons).forEach((id) => {
        let element = document.getElementById(id);
        if (element) {
            element.innerHTML = svgIcons[id] + element.innerHTML;
        }
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    socialLinks.forEach((link) => {
        ...
        if (url.includes("facebook.com")) {
            link.innerHTML = svgIcons.facebook + link.innerHTML;
        } else if (url.includes("youtube.com")) {
            link.innerHTML = svgIcons.youtube + link.innerHTML;
        } else if (url.includes("twitter.com")) {
            link.innerHTML = svgIcons.twitter + link.innerHTML;
        } else if (url.includes("linkedin.com")) {
            link.innerHTML = svgIcons.linkedin + link.innerHTML;
        } else if (url.includes("pinterest.com")) {
            link.innerHTML = svgIcons.pinterest + link.innerHTML;
        } else if (url.includes("instagram.com")) {
            link.innerHTML = svgIcons.instagram + link.innerHTML;
        } else if (url.includes("tiktok.com")) {
            link.innerHTML = svgIcons.tiktok + link.innerHTML;
        } else if (url.includes("google.com")) {
            link.innerHTML = svgIcons.google + link.innerHTML;
        }
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    appLinks.forEach((link) => {
        ...
        // Kiểm tra URL và chèn thẻ SVG bên trong thẻ <a>
        if (url.includes("play.google.com")) {
            link.innerHTML = svgIcons.googleplay + link.innerHTML;
        } else if (url.includes("apps.apple.com")) {
            link.innerHTML = svgIcons.appstore + link.innerHTML;
        }
    });
});
