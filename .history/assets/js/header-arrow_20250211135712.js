...
document.addEventListener("DOMContentLoaded", function () {
    ...
    socialLinks.forEach((link) => {
        ...
        if (url.includes("facebook.com")) {
            ...
            link.insertAdjacentHTML("beforebegin", svgIcons.linkedin); // Thêm SVG Pinterest vào trước <a>
        } else if (url.includes("instagram.com")) {
            link.insertAdjacentHTML("beforebegin", svgIcons.linkedin); // Thêm SVG Instagram vào trước <a>
        } else if (url.includes("tiktok.com")) {
            link.insertAdjacentHTML("beforebegin", svgIcons.linkedin); // Thêm SVG Tiktok vào trước <a>
        } else if (url.includes("google.com")) {
            link.insertAdjacentHTML("beforebegin", svgIcons.linkedin); // Thêm SVG Goofle maps vào trước <a>
        }
